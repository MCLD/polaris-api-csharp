...
{
	/// <summary>
	/// Used to authenticate public requests as a staff member to enable use without the patron's PIN.
	/// </summary>
	public class PolarisOverrideAuthenticator : IAuthenticator
	{
		...
		public void Authenticate(IRestClient client, IRestRequest request)
		{
			...
			request.AddHeader("X-PAPI-AccessToken", _token.AccessToken);
		}
