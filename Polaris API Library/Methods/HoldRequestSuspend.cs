...
namespace Clc.Polaris.Api
{
	public partial class PolarisApiClient
	{
		...
		public HoldRequestActivationResult HoldRequestSuspend(string patronBarcode, int requestID, DateTime activationDate, string patronPIN)
		{
			...
			var request = new RestRequest
				              {
					              Resource =
						              string.Format("public/v1/1033/100/1/patron/{0}/holdrequests/{1}/inactive", patronBarcode, requestID),
					              Method = Method.PUT
				              };
		...
		/// <returns>An error code and message from the API, if any.</returns>
		/// <seealso cref="HoldRequestCancelResult"/>
		public HoldRequestActivationResult staff_HoldRequestSuspend(string patronBarcode, int requestID, DateTime activationDate)
		{
			var doc = new XDocument(
				new XElement("HoldRequestActivationData",
				             new XElement("UserID", 1),
